@echo off
REM Description: Script that queries all services and searches for executables that give the Everyone group RW access.
REM Type: Incorrect file permissions
REM Note: The ^ characters escapes certain characters that break the FOR loop.
REM Note: tokens=1* - The value at the first delimiter and everything after.
